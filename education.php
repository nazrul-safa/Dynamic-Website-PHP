                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        ?>
                                                            ...
                                                            <a href="education_change.php?id=<?= $data['id'] ?>&what_to_do=deactive" class="btn btn-small btn-info">Deactive</a>
                                                        <?php
                                                        else :
                                                        ?>
                                                            ...
                                                            <a href="education_change.php?id=<?= $data['id'] ?>&what_to_do=active" class="btn btn-small btn-warning">Active</a>
                                                        <?php
                                                        endif;
                                                        ?>
                                                    </td>
                    ...
                    <div class="col-6">
                        <div class="card text-white bg-dark mb-3 mt-3">
                            <div class="card-mb-3">
                                ...
                                <div class="card-header bg-info">Add Edication
                                </div>
